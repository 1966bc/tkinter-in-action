...
# chapter:  6.5 - How do I save and restore what was drawn?
# source:   wxPythonInAction-src/Chapter-06/example6.py
# -----------------------------------------------------------------------------
"""example5.py, with New, Open and Save that do something.

The sketch is a list of tuples of a colour, a width and some coordinates,
so pickle takes it as it stands. The dialogs are filedialog, which asks
and returns a name and leaves the opening to you.
"""
import os
import pickle
